...
const Computer = ({ width, height, size, props }) => (
  ...
  >
    ...
    <defs>
      <path
        id="d"
        d="M97.35-88.98c-.91-4.32-4.3-20.06-5.86-27.34-.47-2.21-2.11-3.74-3.99-3.74-5.36 0-15.39.01-16.6.01H26.82c-.61 0-2.56-.01-4.11 1.72C18-113.06 10.16-97.85 8.95-96.31c-.08.1-6.27 2.26-9.09 3.94-1.12.67-1.74 2.12-1.9 3.61L-4.51-68c-.64 4.09 1.7 5.8 5.37 5.8h91.51c2.8 0 5.1-.79 5.1-5.8v-19.74c0-.42-.04-.84-.12-1.24z"
      />
    </defs>
    <path
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop stopColor="#E0E0E0" offset="0.006" />
      <stop stopColor="#9E9E9E" offset="0.999" />
    </linearGradient>
    <path
